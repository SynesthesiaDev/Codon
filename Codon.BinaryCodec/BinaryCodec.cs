...
{
    public static readonly BinaryCodec<bool> BOOLEAN = new BinaryCodecs.BooleanBinaryCodec();

    public static readonly BinaryCodec<byte> BYTE = new BinaryCodecs.ByteBinaryCodec();

    public static readonly BinaryCodec<int> INT = new BinaryCodecs.IntBinaryCodec();

    public static readonly BinaryCodec<long> LONG = new BinaryCodecs.LongBinaryCodec();

    public static readonly BinaryCodec<double> DOUBLE = new BinaryCodecs.DoubleBinaryCodec();

    public static readonly BinaryCodec<float> FLOAT = new BinaryCodecs.FloatBinaryCodec();

    public static readonly BinaryCodec<int> VAR_INT = new BinaryCodecs.VarIntBinaryCodec();

    public static readonly BinaryCodec<byte[]> BYTE_ARRAY = new BinaryCodecs.ByteArrayBinaryCodec();

    public static readonly BinaryCodec<IByteBuffer> BYTE_BUFFER = new BinaryCodecs.ByteBufferBinaryCodec();

    public static readonly BinaryCodec<byte[]> RAW_BYTES = new BinaryCodecs.RawBytesBinaryCodec();

    public static readonly BinaryCodec<string> STRING = new BinaryCodecs.StringBinaryCodec();

    public static readonly BinaryCodec<Guid> GUID = BYTE_ARRAY.Transform(guid => guid.ToByteArray(), bytes => new Guid(bytes));

    public static BinaryCodecs.RecursiveBinaryCodec<T> Recursive<T>(Func<BinaryCodec<T>, BinaryCodec<T>> self) where T : notnull => new(self);

    public static BinaryCodec<byte[]> ByteArray(int? maxSize = null) => new BinaryCodecs.ByteArrayBinaryCodec(maxSize);

    public static BinaryCodec<IByteBuffer> ByteBuffer(int? maxSize = null) => new BinaryCodecs.ByteBufferBinaryCodec(maxSize);

    public static BinaryCodecs.EnumBinaryCodec<E> Enum<E>() where E : Enum => new();

    public static BinaryCodec<Te> Flags<Te>() where Te : struct, Enum => BYTE.Transform(te => Unsafe.As<Te, byte>(ref te), by => Unsafe.As<byte, Te>(ref by));

    public static BinaryCodec<string> String(int maxLength) => new BinaryCodecs.StringBinaryCodec(maxLength);

    public static BinaryCodec<R> Empty<R>(Func<R> func) => new BinaryCodecs.BinaryCodecEmpty<R>(func);

    public static BinaryCodec<R> Of<P1, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        Func<P1, R> func
    )
    {
    ...
    public static BinaryCodec<R> Of<P1, P2, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        Func<P1, P2, R> func
    )
    {
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, P4, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
        BinaryCodec<P4> codec4, Func<R, P4> getter4,
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, P4, P5, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
        BinaryCodec<P4> codec4, Func<R, P4> getter4,
        BinaryCodec<P5> codec5, Func<R, P5> getter5,
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, P4, P5, P6, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
        BinaryCodec<P4> codec4, Func<R, P4> getter4,
        BinaryCodec<P5> codec5, Func<R, P5> getter5,
        BinaryCodec<P6> codec6, Func<R, P6> getter6,
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, P4, P5, P6, P7, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
        ...
        BinaryCodec<P5> codec5, Func<R, P5> getter5,
        BinaryCodec<P6> codec6, Func<R, P6> getter6,
        BinaryCodec<P7> codec7, Func<R, P7> getter7,
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, P4, P5, P6, P7, P8, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
        ...
        BinaryCodec<P6> codec6, Func<R, P6> getter6,
        BinaryCodec<P7> codec7, Func<R, P7> getter7,
        BinaryCodec<P8> codec8, Func<R, P8> getter8,
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, P4, P5, P6, P7, P8, P9, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
        ...
        BinaryCodec<P7> codec7, Func<R, P7> getter7,
        BinaryCodec<P8> codec8, Func<R, P8> getter8,
        BinaryCodec<P9> codec9, Func<R, P9> getter9,
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
        ...
        BinaryCodec<P8> codec8, Func<R, P8> getter8,
        BinaryCodec<P9> codec9, Func<R, P9> getter9,
        BinaryCodec<P10> codec10, Func<R, P10> getter10,
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
        ...
        BinaryCodec<P9> codec9, Func<R, P9> getter9,
        BinaryCodec<P10> codec10, Func<R, P10> getter10,
        BinaryCodec<P11> codec11, Func<R, P11> getter11,
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
        ...
        BinaryCodec<P10> codec10, Func<R, P10> getter10,
        BinaryCodec<P11> codec11, Func<R, P11> getter11,
        BinaryCodec<P12> codec12, Func<R, P12> getter12,
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
        ...
        BinaryCodec<P11> codec11, Func<R, P11> getter11,
        BinaryCodec<P12> codec12, Func<R, P12> getter12,
        BinaryCodec<P13> codec13, Func<R, P13> getter13,
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
        ...
        BinaryCodec<P12> codec12, Func<R, P12> getter12,
        BinaryCodec<P13> codec13, Func<R, P13> getter13,
        BinaryCodec<P14> codec14, Func<R, P14> getter14,
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
        ...
        BinaryCodec<P13> codec13, Func<R, P13> getter13,
        BinaryCodec<P14> codec14, Func<R, P14> getter14,
        BinaryCodec<P15> codec15, Func<R, P15> getter15,
    ...
    public static BinaryCodec<R> Of<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, R>
    (
        BinaryCodec<P1> codec1, Func<R, P1> getter1,
        BinaryCodec<P2> codec2, Func<R, P2> getter2,
        BinaryCodec<P3> codec3, Func<R, P3> getter3,
        ...
        BinaryCodec<P14> codec14, Func<R, P14> getter14,
        BinaryCodec<P15> codec15, Func<R, P15> getter15,
        BinaryCodec<P16> codec16, Func<R, P16> getter16,
...
public interface BinaryCodec<T>
{
    ...
    BinaryCodecs.DictionaryBinaryCodec<T, V> MapTo<V>(BinaryCodec<V> valueCodec, int? maxSize = null) where V : notnull
    {
        return new BinaryCodecs.DictionaryBinaryCodec<T, V>(this, valueCodec, maxSize);
    }

    BinaryCodecs.ListBinaryCodec<T> List(int? maxSize = null)
    {
        return new BinaryCodecs.ListBinaryCodec<T>(this, maxSize);
    }

    BinaryCodecs.UnionBinaryCodec<K, T> Union<K>(Func<T, BinaryCodec<K>> serializerFactory, Func<K, T> keyFunc) where K : notnull
    {
